class Thermostat{
  ...
  increaseTemp( num = 1) {
    ...
    } else if(this.powersaving === false && (this.temperature + num) >= 32 ) {
      throw new Error('The temp cannot be increased more than 32 degrees whith PS mode OFF')
    } else {
